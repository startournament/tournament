...
def Image_obj(obj):
    if obj in lat_rus_dict:
        ...
        if y == 0:
            y = 110
        list_ans = ['<p><table class="Table"><tr><td>Назвние:</td><td>'+messier_dict[obj]['name']+'</td></tr><tr><td>Созвездие: </td><td>'+messier_dict[obj]['constellation']+'</td></tr><tr><td>Тип: </td><td>'+messier_dict[obj]['type']+'</td></tr><tr><td>Расстояние: </td><td>'+messier_dict[obj]['distance']+'</td></tr><tr><td>Звездная величина: </td><td>'+messier_dict[obj]['magnitude']+'</td></tr></table></p>']
